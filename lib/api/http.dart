...
/// Wrapper around the [KaminoHttpClient] (based off package:http/http.dart).
/// https://pub.dartlang.org/packages/dio might be a cleaner alternative, but
...
Future<T> _withClient<T>(Future<T> fn(Client client)) async {
  var client = new KaminoHttpClient();
  try {
